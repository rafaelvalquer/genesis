...
- Corrigida incompatibilidade de UTF-8 sem BOM com Windows PowerShell 5.1.
- `install.ps1` e `validate.ps1` agora usam BOM UTF-8.
- O padrão de reconhecimento do orçamento de assets não depende mais de acentos.
- Removido BOM invisível das linhas antes da classificação.
- Mantida a política de aceitar somente as pendências conhecidas de assets.
