# Genesis — Final de onda cinematográfico v2.0.0
...
```powershell
cd "C:\Projetos\Genesis\genesis-wave-outro-cinematic-v2.0.0"
...
```text
.genesis-backups\wave-outro-cinematic-v2.0.0\<timestamp>
```
