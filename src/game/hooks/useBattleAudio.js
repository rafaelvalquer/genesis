...
export function createBattleAudioChannels(assets, chapterId = null) {
  ...
  return {
    ...
    treeBroodOpen: buildFirst("c7_tree_brood_open"),
    larvaEmerge: buildFirst("c7_larva_emerge"),
    larvaAttack: buildFirst("c7_larva_attack"),
    larvaDeath: buildFirst("c7_larva_death"),
