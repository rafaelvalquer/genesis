...
export const TROOPS = {
  ...
  mantis: {
    ...
    attackEveryMs: 2700,
    projectileSpeed: 520,
    attack: "mantisSaturation",
    color: "#e879f9",
    unlockAt: 45,
    assetStates: ["idle", "targetLock", "attackBurst", "reload", "paralyzed", "death"],
    idleVisual: { state: "idle", height: 118, aspectRatio: 0.78, durationMs: 1120, loop: true },
    targetLockVisual: { state: "targetLock", height: 118, aspectRatio: 0.78, durationMs: 420, loop: false },
    attackVisual: { state: "attackBurst", height: 118, aspectRatio: 0.78, durationMs: 720, loop: false },
    reloadVisual: { state: "reload", height: 118, aspectRatio: 0.78, durationMs: 620, loop: false },
    paralyzedVisual: { state: "paralyzed", height: 118, aspectRatio: 0.78, durationMs: 820, loop: true },
    deathVisual: { state: "death", height: 118, aspectRatio: 0.78, durationMs: 900, loop: false },
    description: "Artilheira cyberpunk de saturação: distribui seis micro-mísseis guiados entre os inimigos mais avançados da rota.",
  },
  executorArco: {
    glassEchoShatter: true,
    id: "executorArco",
