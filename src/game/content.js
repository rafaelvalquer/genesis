...
export const ENEMIES = {
  ...
  colossoCaldeira: {
    ...
    animationFrameProgress: {
      // Deliberate, evenly staged emergence. The old curve rushed through the
      // first poses and held the last frame for most of the spawn state.
      spawnAwakening: [0, .08, .16, .24, .32, .40, .48, .56, .64, .72, .82, .92],
      riftTelegraph: [0, .13, .28, .45, .64, .84], riftAttack: [0, .11, .25, .5777778, .76, .92],
      slamTelegraph: [0, .13, .28, .45, .64, .84], slamAttack: [0, .10, .22, .40, .626087, .74, .86, .96],
    ...
    attackExecutionMs: { rift: 900, slam: 1150, fracture: 1900, seismic: 1400 },
    attackImpactProgress: { rift: .58, slam: .62, fracture: .42, seismic: .45 },
    attackImpactFrame: { rift: 3, slam: 4, fracture: 4, seismic: 3 },
    attackImpactMs: { rift: 520, slam: 720, fracture: 798, seismic: 630 },
