...
export const ENEMIES = {
  ...
  silicaDigger: {
    id: "silicaDigger", label: "Escavador de Sílica", role: "Básico / enxame",
    hp: 8, speed: 62, damage: 3, attackEveryMs: 600, baseDamage: 6, threat: 6,
    color: "#22d3ee", scale: 0.64, chapterId: "chapter_03", encyclopediaUnlockAt: 0,
    animationFrameMs: { idle: 110, walking: 65 },
    attackVisual: { durationMs: 480, impactMs: 200 },
    swarmMinCount: 3, swarmSpeedFactor: 1.25,
    description: "Escavador subterrâneo frágil e veloz que ganha impulso quando avança agrupado com sua ninhada.",
  },
  duneRipper: {
    id: "duneRipper", label: "Rasga-Dunas", role: "Elite / invocador / corpo a corpo",
    hp: 110, speed: 24, damage: 7, attackEveryMs: 1250, baseDamage: 24, threat: 24,
    color: "#22d3ee", scale: 1.25, chapterId: "chapter_03", encyclopediaUnlockAt: 16,
    ...
    firstSummonDelayMs: 4500, summonEveryMs: 8000, summonCount: 3,
    maximumLivingSummons: 6, summonRetryMs: 1000, interruptedSummonRetryMs: 2000,
    roarDurationMs: 1300, roarSummonAtMs: 750,
    description: "Predador adulto das Dunas de Quitina que rasga a linha enquanto convoca novas ninhadas de Escavadores de Sílica.",
  },
  ramBeetle: {
    id: "ramBeetle", label: "Besouro-Aríete", role: "Tanque / Rompedor / Investida",
    hp: 165, speed: 12, damage: 12, attackEveryMs: 2200, baseDamage: 35, threat: 30,
    color: "#f59e0b", scale: 1.55, chapterId: "chapter_03", encyclopediaUnlockAt: 16,
    assetStates: ["walking", "chargePrep", "charge", "idle", "attack"],
    animationFrameMs: { walking: 120, charge: 55, idle: 180 },
    chargeDamage: 55, chargePrepMs: 650, chargeSpeed: 240, chargeRange: 1,
    recoverMs: 2000,
    attackVisual: { durationMs: 800, impactMs: 400 },
    description: "Tanque biológico das Dunas de Quitina que rompe a linha com um primeiro impacto devastador e fica exposto enquanto recupera o equilíbrio.",
  },
  scarabEmperor: {
    id: "scarabEmperor", label: "Imperador Escaravelho", role: "Chefe / tanque evolutivo / corpo a corpo",
    hp: 600, speed: 28, damage: 16, attackEveryMs: 2200, baseDamage: 50, threat: 60,
    color: "#f59e0b", scale: 1.9, chapterId: "chapter_03", encyclopediaUnlockAt: 16,
    boss: true, allowAlphaVariant: false, knockbackImmune: true,
    previewState: "phase1Idle",
    phase2Threshold: 0.65,
    phase3Threshold: 0.30,
    phase1: {
      speed: 28, speedTilesPerSecond: 0.28,
      damage: 16, attackEveryMs: 2200, attackDurationMs: 900, attackImpactMs: 560,
      attackRangeTiles: 0.45, frontDamageFactor: 0.60, damageTakenFactor: 1,
    },
    transitionPhase1To2: { durationMs: 1800 },
    phase2: {
      speed: 52, speedTilesPerSecond: 0.52,
      damage: 10, attackEveryMs: 1500, attackDurationMs: 650, attackImpactMs: 360,
      attackRangeTiles: 0.45, frontDamageFactor: 1, damageTakenFactor: 1.15,
    },
    transitionPhase2To3: { durationMs: 1600 },
    phase3: {
      speed: 95, speedTilesPerSecond: 0.95,
      damage: 6, attackEveryMs: 650, attackDurationMs: 420, attackImpactMs: 220,
      attackRangeTiles: 0.40, frontDamageFactor: 1, damageTakenFactor: 1.30,
    },
    assetStates: [
      "phase1Walking", "phase1Idle", "phase1Attack", "phase1Hit", "transitionPhase1To2",
      "phase2Walking", "phase2Idle", "phase2Attack", "phase2Hit", "transitionPhase2To3",
      "phase3Walking", "phase3Idle", "phase3Attack", "phase3Hit", "death",
    ],
    animationFrameMs: {
      phase1Walking: 150, phase1Idle: 190,
      phase2Walking: 105, phase2Idle: 145,
      phase3Walking: 65, phase3Idle: 100,
    },
    description: "Soberano das Dunas de Quitina que abandona a prÃ³pria carapaÃ§a para se tornar mais veloz, vulnerÃ¡vel e agressivo conforme perde vida.",
  },
  workerQueen: {
    id: "workerQueen", label: "Rainha Operária", role: "Invocadora / suporte de enxame",
    hp: 90, speed: 10, damage: 3, attackEveryMs: 1700, baseDamage: 18, threat: 30,
    color: "#f59e0b", scale: 1.52, chapterId: "chapter_03", encyclopediaUnlockAt: 16,
    assetStates: ["spawn", "walking", "idle", "webAttack", "eggLay", "meleeAttack", "hit", "stunned", "death"],
    ...
    webAttackVisual: { durationMs: 900, releaseMs: 450, effect: "inhibitorWeb", muzzle: { x: 0.24, y: 0.68 } },
    ...
    description: "Matriarca lenta que mantém distância, inibe a cadência das tropas e deposita ovos destrutíveis de Escavadores de Sílica.",
  },
  workerQueenEgg: {
    id: "workerQueenEgg", label: "Ovo da Rainha", role: "Invocação destrutível",
    hp: 14, speed: 0, damage: 0, attackEveryMs: 0, baseDamage: 0, threat: 0,
    color: "#fbbf24", scale: 0.72, chapterId: "chapter_03",
    ...
    description: "Ovo imóvel e destrutível que gera um Escavador de Sílica ao completar a incubação.",
  },
};
...
export const PHASES = [
  ...
  phase("fase_17", "Limiar das Dunas", "O enxame emerge sob a sílica viva", 270, 920, "chitin", 720000, [
    ...
    budgetedWave(2100, ["silex", "brakor"], [{ type: "duneRipper", count: 1 }]),
    budgetedWave(2300, ["silex", "brakor"], [{ type: "duneRipper", count: 1 }]),
    budgetedWave(2600, ["silex", "brakor"], [{ type: "duneRipper", count: 2 }]),
  ]),
  phase("fase_18", "Ossário do Sol", "Sombras antigas cobrem a marcha", 290, 880, "chitin", 750000, [
    budgetedWave(1900, ["silex"]),
    budgetedWave(2100, ["silex", "brakor"], [{ type: "duneRipper", count: 1 }]),
    budgetedWave(2300, ["silex", "brakor"], [{ type: "duneRipper", count: 1 }, { type: "workerQueen", count: 1 }]),
    budgetedWave(2500, ["silex", "brakor"], [{ type: "duneRipper", count: 2 }, { type: "workerQueen", count: 1 }]),
    budgetedWave(2900, ["silex", "brakor"], [{ type: "duneRipper", count: 2 }, { type: "workerQueen", count: 2 }]),
  ]),
  phase("fase_19", "Cratera de Âmbar", "Veios orgânicos cercam a linha", 315, 840, "chitin", 780000, [
    budgetedWave(2100, ["silex"]),
    budgetedWave(2300, ["silex", "brakor"], [{ type: "duneRipper", count: 1 }, { type: "workerQueen", count: 1 }]),
    budgetedWave(2500, ["silex", "brakor"], [{ type: "duneRipper", count: 2 }, { type: "workerQueen", count: 1 }]),
    budgetedWave(2700, ["silex", "brakor"], [{ type: "duneRipper", count: 2 }, { type: "workerQueen", count: 2 }, { type: "ramBeetle", count: 1 }]),
    budgetedWave(3300, ["silex", "brakor"], [{ type: "duneRipper", count: 3 }, { type: "workerQueen", count: 2 }, { type: "ramBeetle", count: 2 }]),
  ]),
  phase("fase_20", "Galerias Rasas", "A areia respira sobre as cavernas", 340, 800, "chitin", 810000, [
    budgetedWave(2320, ["silex"]),
    budgetedWave(2550, ["silex", "brakor"], [{ type: "duneRipper", count: 1 }, { type: "workerQueen", count: 1 }, { type: "ramBeetle", count: 1 }]),
    budgetedWave(2780, ["silex", "brakor"], [{ type: "duneRipper", count: 2 }, { type: "workerQueen", count: 1 }, { type: "ramBeetle", count: 1 }]),
    budgetedWave(3050, ["silex", "brakor"], [{ type: "duneRipper", count: 2 }, { type: "workerQueen", count: 2 }, { type: "ramBeetle", count: 2 }]),
    budgetedWave(3800, ["silex", "brakor"], [{ type: "duneRipper", count: 3 }, { type: "workerQueen", count: 3 }, { type: "ramBeetle", count: 3 }, { type: "silex", variant: "alpha", count: 1 }]),
  ]),
  phase("fase_21", "Berçário Sepultado", "Seis marés rompem o ninho", 370, 760, "chitin", 900000, [
    budgetedWave(2600, ["silex"]),
    budgetedWave(2800, ["silex", "brakor"], [{ type: "duneRipper", count: 1 }, { type: "workerQueen", count: 1 }, { type: "ramBeetle", count: 1 }]),
    budgetedWave(3000, ["silex", "brakor"], [{ type: "duneRipper", count: 2 }, { type: "workerQueen", count: 1 }, { type: "ramBeetle", count: 1 }]),
    budgetedWave(3300, ["silex", "brakor"], [{ type: "duneRipper", count: 2 }, { type: "workerQueen", count: 2 }, { type: "ramBeetle", count: 2 }]),
    budgetedWave(3600, ["silex", "brakor"], [{ type: "duneRipper", count: 3 }, { type: "workerQueen", count: 2 }, { type: "ramBeetle", count: 2 }]),
    budgetedWave(4300, ["silex", "brakor"], [{ type: "duneRipper", count: 4 }, { type: "workerQueen", count: 3 }, { type: "ramBeetle", count: 3 }, { type: "brakor", variant: "alpha", count: 1 }]),
  ]),
  phase("fase_22", "Bosque de Agulhas", "Cristais orgânicos fecham o horizonte", 405, 720, "chitin", 960000, [
    budgetedWave(2900, ["silex"]),
    budgetedWave(3150, ["silex", "brakor"], [{ type: "duneRipper", count: 2 }, { type: "workerQueen", count: 1 }, { type: "ramBeetle", count: 1 }]),
    budgetedWave(3400, ["silex", "brakor"], [{ type: "duneRipper", count: 2 }, { type: "workerQueen", count: 2 }, { type: "ramBeetle", count: 2 }]),
    budgetedWave(3700, ["silex", "brakor"], [{ type: "duneRipper", count: 3 }, { type: "workerQueen", count: 2 }, { type: "ramBeetle", count: 2 }, { type: "silex", variant: "alpha", count: 1 }]),
    budgetedWave(4050, ["silex", "brakor"], [{ type: "duneRipper", count: 3 }, { type: "workerQueen", count: 3 }, { type: "ramBeetle", count: 3 }]),
    budgetedWave(4800, ["silex", "brakor"], [{ type: "duneRipper", count: 4 }, { type: "workerQueen", count: 4 }, { type: "ramBeetle", count: 4 }, { type: "brakor", variant: "alpha", count: 1 }]),
  ]),
  phase("fase_23", "Vale da Poeira Viva", "O céu incandescente engole o campo", 440, 680, "chitin", 1020000, [
    budgetedWave(3200, ["silex"]),
    budgetedWave(3500, ["silex", "brakor"], [{ type: "duneRipper", count: 2 }, { type: "workerQueen", count: 2 }, { type: "ramBeetle", count: 1 }]),
    budgetedWave(3800, ["silex", "brakor"], [{ type: "duneRipper", count: 3 }, { type: "workerQueen", count: 2 }, { type: "ramBeetle", count: 2 }, { type: "silex", variant: "alpha", count: 1 }]),
    budgetedWave(4150, ["silex", "brakor"], [{ type: "duneRipper", count: 3 }, { type: "workerQueen", count: 3 }, { type: "ramBeetle", count: 3 }]),
    budgetedWave(4550, ["silex", "brakor"], [{ type: "duneRipper", count: 4 }, { type: "workerQueen", count: 3 }, { type: "ramBeetle", count: 4 }, { type: "brakor", variant: "alpha", count: 1 }]),
    budgetedWave(5400, ["silex", "brakor"], [{ type: "duneRipper", count: 5 }, { type: "workerQueen", count: 4 }, { type: "ramBeetle", count: 5 }, { type: "silex", variant: "alpha", count: 1 }]),
  ]),
  phase("fase_24", "Trono de Quitina", "Resista à maré sob a coroa ancestral", 480, 640, "chitin", 1080000, [
    budgetedWave(3550, ["silex"]),
    budgetedWave(3900, ["silex", "brakor"], [{ type: "duneRipper", count: 2 }, { type: "workerQueen", count: 2 }, { type: "ramBeetle", count: 2 }, { type: "silex", variant: "alpha", count: 1 }]),
    budgetedWave(4250, ["silex", "brakor"], [{ type: "duneRipper", count: 3 }, { type: "workerQueen", count: 3 }, { type: "ramBeetle", count: 3 }]),
    budgetedWave(4650, ["silex", "brakor"], [{ type: "duneRipper", count: 4 }, { type: "workerQueen", count: 3 }, { type: "ramBeetle", count: 3 }, { type: "brakor", variant: "alpha", count: 1 }]),
    budgetedWave(5100, ["silex", "brakor"], [{ type: "duneRipper", count: 5 }, { type: "workerQueen", count: 4 }, { type: "ramBeetle", count: 4 }, { type: "silex", variant: "alpha", count: 1 }]),
    budgetedWave(6000, ["silex", "brakor"], [{ type: "duneRipper", count: 4 }, { type: "workerQueen", count: 3 }, { type: "ramBeetle", count: 4 }, { type: "scarabEmperor", count: 1 }]),
  ], { boss: true }),
];
