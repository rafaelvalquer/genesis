...
export const ENEMIES = {
  ...
  colossoCaldeira: {
    ...
    assetStates: ["spawnAwakening", "idle", "riftTelegraph", "slamTelegraph", "fractureTelegraph", "seismicTelegraph", "phaseTransition2", "phaseTransition3", "finalCollapse", "coreExposed", "death"],
    animationFrameMs: { idle: 120, coreExposed: 90 }, effectDependencies: Object.freeze([]),
    ...
    rift: { maxActive: { 1: 1, 2: 2, 3: 3 }, durationMs: 9000, spawnDelayMs: 1100, spawnTypes: [["cuspidorBrasa", "predadorCaldeira"], ["vermeIncubador", "cuspidorBrasa", "predadorCaldeira"], ["devoradorCaldeira", "predadorCaldeira", "salamandraCinerea"]] },
    slam: { damageFactor: { 1: .25, 2: .30, 3: .35 }, stunMs: 1400 },
    fracture: { durationMs: { 2: 9000, 3: 12000 } }, finalCollapse: { telegraphMs: 3600 },
