...
export const ENEMIES = {
  ...
  colossoCaldeira: {
    ...
    animationFrameMs: { idle: 120, coreExposed: 90 },
    animationFrameProgress: {
      spawnAwakening: [0, .045, .09, .14, .20, .26, .32, .38, .44, .50, .56, .62],
      riftTelegraph: [0, .18, .36, .54, .72, .88], riftAttack: [0, .16, .34, .58, .76, .90],
      slamTelegraph: [0, .18, .36, .54, .72, .88], slamAttack: [0, .12, .25, .40, .62, .74, .85, .94],
    ...
    attackImpactMs: { rift: 377, slam: 527, fracture: 798, seismic: 630 },
