...
export const TROOPS = {
  ...
  interceptadorIcaro: {
    ...
    title: "Especialista Antiaéreo",
    role: "Antiaéreo / Rajada",
    spriteKey: "interceptadorIcaro",
    price: 24,
    supply: 6,
    ...
    attackEveryMs: 2000,
    projectileSpeed: 620,
    airborneDamageFactor: 1.3,
    groundDamageFactor: 0.5,
    nimbarcaShieldIgnoreFactor: 0.5,
    interceptionCooldownMs: 12000,
    ...
    color: "#22d3ee",
    unlockAt: 24,
    assetStates: ["idle", "attackBurst", "interceptionLock", "interceptionFire", "paralyzed", "death"],
    idleVisual: {
      state: "idle",
      height: 115.5,
      durationMs: 1040,
    ...
    attackVisual: {
      ...
      // previews, battle rendering and muzzle effects use that same reference.
      frameAnchors: {
        idle: Array.from({ length: 8 }, () => ({ x: 0.5, y: 0.96875, scale: 1 })),
        attackBurst: Array.from({ length: 8 }, () => ({ x: 0.5, y: 0.96875, scale: 1 })),
        interceptionLock: Array.from({ length: 8 }, () => ({ x: 0.5, y: 0.96875, scale: 1 })),
        interceptionFire: Array.from({ length: 8 }, () => ({ x: 0.5, y: 0.96875, scale: 1 })),
        paralyzed: Array.from({ length: 8 }, () => ({ x: 0.5, y: 0.96875, scale: 1 })),
        death: Array.from({ length: 8 }, () => ({ x: 0.5, y: 0.96875, scale: 1 })),
      },
      frameMuzzles: [
        { x: 0.8906, y: 0.4673 }, { x: 0.8867, y: 0.4647 },
        { x: 0.9062, y: 0.468 }, { x: 0.9023, y: 0.4385 },
        { x: 0.8945, y: 0.4623 }, { x: 0.918, y: 0.4183 },
        { x: 0.8906, y: 0.465 }, { x: 0.8906, y: 0.4671 },
      ],
    ...
    interceptionFireVisual: {
      ...
      durationMs: 700,
      frameMuzzles: [
        { x: 0.8906, y: 0.4681 }, { x: 0.9336, y: 0.3897 },
        { x: 0.9062, y: 0.4483 }, { x: 0.9297, y: 0.3757 },
        { x: 0.9258, y: 0.4247 }, { x: 0.9375, y: 0.4284 },
        { x: 0.8906, y: 0.4681 }, { x: 0.8906, y: 0.467 },
      ],
