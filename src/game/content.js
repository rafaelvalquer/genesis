...
export const TROOPS = {
  ...
  aresT: {
    ...
    spriteScale: 1.15,
    assetStates: ["idle", "attack", "death"],
    idleVisual: { state: "idle", height: 110, aspectRatio: 1.32, durationMs: 960, loop: true },
    attackVisual: { state: "attack", height: 110, aspectRatio: 1.32, durationMs: 720, impactMs: 470, effect: "aresHydraulicPunch", loop: false },
    deathVisual: { state: "death", height: 110, aspectRatio: 1.32, durationMs: 880, loop: false },
  ...
  thermalPlatform: {
    ...
    heatedVisual: { state: "heated", height: 92, aspectRatio: 1, durationMs: 0, loop: false },
    criticalVisual: { state: "critical", height: 92, aspectRatio: 1, durationMs: 0, loop: false },
  ...
  interceptadorIcaro: {
    ...
    attackVisual: {
      ...
      frameAnchors: {
        ...
        interceptionFireUp: Array.from({ length: 8 }, () => ({ x: 0.5, y: 0.96875, scale: 1 })),
        interceptionFireDown: Array.from({ length: 8 }, () => ({ x: 0.5, y: 0.96875, scale: 1 })),
  ...
  mantis: {
    id: "mantis",
    label: "MANTIS",
    title: "Operadora de Micro-Mísseis",
    role: "Artilharia / Saturação",
    spriteKey: "mantis",
    price: 25,
    supply: 3,
    deployCooldownMs: 7000,
    ...
    spikeArcHeight: 170,
    attackEveryMs: 2900,
    attack: "mantisArcSpikes",
    color: "#e879f9",
    unlockAt: 44,
    assetStates: ["idle", "targetLock", "arcSpikeAttack", "rearm", "paralyzed", "death"],
    healthBarOffset: 60,
    idleVisual: { state: "idle", height: 112, aspectRatio: 0.78, durationMs: 1120, loop: true },
    ...
    description: "Dispara spikes-mísseis em arco que se cravam nos alvos e explodem após um curto atraso, excelente contra enxames compactos.",
  },
  executorArco: {
    glassEchoShatter: true,
    id: "executorArco",
...
const TROOP_TAXONOMY = Object.freeze({
  ...
  mantis: { tags: ["offense", "ranged", "area", "saturation"], counters: ["light"] },
...
export const ENEMIES = {
  ...
  salamandraCinerea: {
    ...
    attackVisual: { durationMs: 600, impactMs: 400 },
    charge: { enabled: true, delayAfterSpawnMs: 1500, minDistance: 150, maxDistance: 260, speedMultiplier: 1.25, durationMs: 700, cooldownMs: 8000 },
    description: "Predador vulcânico ágil que realiza curtos impulsos para se aproximar da defesa.",
    testOnly: true,
  },
  rasgaCeusCinereo: {
    id: "rasgaCeusCinereo",
    ...
    armorClass: "light",
    cruiseAltitude: 30,
    maximumFlightAltitude: 38,
    groundTargetAltitude: 18,
    targetLockMs: 900,
    diveDurationMs: 650,
    climbDurationMs: 750,
    diveCooldownMs: 6500,
    huntAheadTiles: 3,
    huntBehindTiles: 0.5,
    patrolPaddingTiles: 0.65,
    minimumPatrolSpanTiles: 2.5,
    turnDurationMs: 320,
    strikeStandOffTiles: 0.9,
    strikeAltitude: 10,
    climbForwardTiles: 0.35,
    baseApproachSpeedFactor: 1,
    scale: 0.9,
    airborneVisualScaleMin: 0.68,
    color: "#b45309",
    assetStates: ["flying", "diveAttack", "death"],
    previewState: "flying",
    animationFrameMs: { flying: 90, diveAttack: 80, death: 100 },
    description: "Predador aéreo que marca uma tropa, mergulha para executar um rasante e se expõe temporariamente ao fogo terrestre.",
    testOnly: true,
  },
  devoradorCaldeira: {
    ...
    magmaImmune: true,
    frenzyThreshold: 0.4,
    frenzySpeedFactor: 1.25,
    frenzyAttackSpeedFactor: 1.2,
    frenzyArmorDamageFactor: 1,
    crushingBiteEvery: 3,
    crushingBiteDamage: 15,
    crushingBiteStunMs: 900,
    meleeContactDistancePx: 66,
    scale: 1.48,
    assetStates: ["idle", "walking", "attack", "crushingBite", "frenzyTransition", "death"],
    previewState: "idle",
    animationFrameMs: { idle: 160, walking: 125, attack: 90, crushingBite: 110, frenzyTransition: 80, death: 110 },
    attackVisual: { durationMs: 720, impactMs: 450 },
    crushingBiteVisual: { durationMs: 900, impactMs: 560 },
    frenzyTransitionVisual: { durationMs: 640 },
    spriteOffsetY: 40,
    description: "Predador maciço que absorve dano com sua postura defensiva, desfere Mordidas Esmagadoras e entra em Frenesi quando gravemente ferido.",
    testOnly: true,
  },
  predadorCaldeira: {
    id: "predadorCaldeira",
    ...
    threat: 25,
    armorClass: "medium",
    armorDamageFactor: 0.88,
    magmaImmune: true,
    knockbackFactor: 0.65,
    hunt: { minDistanceTiles: 1.5, maxDistanceTiles: 4.5, speedMultiplier: 1.55 },
    frenzyThreshold: 0.40,
    frenzySpeedFactor: 1.25,
    frenzyAttackSpeedFactor: 1.25,
    frenzyArmorDamageFactor: 1,
    frenzyAnimationSpeedFactor: 1.18,
    meleeContactDistancePx: 58,
    scale: 1.3,
    spriteOffsetY: 8,
    assetStates: ["idle", "walking", "hunting", "attackCombo", "frenzyTransition", "death"],
    previewState: "idle",
    animationFrameMs: { idle: 150, walking: 120, hunting: 85, attackCombo: 100, frenzyTransition: 90, death: 110 },
  ...
  vermeIncubador: {
    ...
    threat: 28,
    armorClass: "medium",
    knockbackFactor: 0.45,
    magmaImmune: true,
    incubationInitialDelayMs: 7000,
    incubationCooldownMs: 14000,
    burrowDurationMs: 800,
    undergroundTravelMs: 450,
    emergeDurationMs: 800,
    targetBurrowDurationMs: 750,
    returnTravelMs: 450,
    returnEmergeDurationMs: 800,
    eruptionDurationMs: 8000,
    fissureCloseVisualMs: 600,
    recentTargetCooldownMs: 18000,
    maxConcurrentFissures: 3,
    targetEmergenceOffsetTiles: 0.60,
    meleeContactDistancePx: 62,
    scale: 1.4,
    spriteOffsetY: 48,
    assetStates: ["idle", "attack", "burrowing", "emerging", "death"],
    previewState: "idle",
    animationFrameMs: { idle: 150, attack: 95, burrowing: 100, emerging: 100, death: 115 },
    attackVisual: { durationMs: 760, impactMs: 500 },
    incubationAttackVisual: { durationMs: 700, impactMs: 460 },
    description: "Criatura subterrânea que abre fissuras temporárias sob as tropas, transformando o terreno em magma eruptivo.",
    testOnly: true,
  },
  neurax: {
    id: "neurax",
  ...
  enguiaRasgamar: {
    id: "enguiaRasgamar",
    label: "Enguia Rasgamar",
    role: "Assassino aquático",
    hp: 60,
    speed: 39,
    damage: 6,
    attackEveryMs: 5500,
    ...
    triggersGroundTraps: false,
    knockbackImmune: true,
    assetStates: ["spawnSubmerged", "swimSubmerged", "tideEscape", "rangedEmerge", "rangedCharge", "rangedAttack", "surfaceRecovery", "coilEmerge", "coilAttack", "coilRelease", "dive", "deathSurface", "deathSubmerged"],
    previewState: "surfaceRecovery",
    animationFrameMs: { spawnSubmerged: 80, swimSubmerged: 60, tideEscape: 40, rangedEmerge: 70, rangedCharge: 80, rangedAttack: 60, surfaceRecovery: 100, coilEmerge: 60, coilAttack: 87, coilRelease: 70, dive: 60, deathSurface: 100, deathSubmerged: 90 },
    submergedSpawnMs: 640,
    coilEmergeMs: 480,
    coilDurationMs: 1400,
    coilPulseTimes: [350, 700, 1050],
    coilInitialDamage: 4,
    coilPulseDamage: 5,
    coilCooldownMs: 4500,
    coilRecoveryMs: 700,
    ...
    coilAttackSlowMs: 3000,
    rangedAttackSlowFactor: 0.85,
    rangedAttackSlowMs: 2500,
    submergedAreaDamageFactor: 0.25,
    description: "Predador abissal bioluminescente que embosca tropas alagadas, muda de rota ao ficar sem alvos e ataca a base quando não restam tropas.",
  },
  colossoCaldeira: {
    ...
    color: "#f97316", scale: 3.25, visualOffsetY: -42, bossAnchorRow: 2, spawnDurationMs: 4800,
    assetStates: ["spawnAwakening", "idle", "riftTelegraph", "riftCast", "slamTelegraph", "slamAttack", "fractureTelegraph", "fractureAttack", "seismicTelegraph", "seismicAttack", "phaseTransition2", "phaseTransition3", "finalCollapse", "coreExposed", "death"],
    animationFrameMs: { idle: 120, coreExposed: 90 }, effectDependencies: Object.freeze(["colossoRift", "colossoSlam", "colossoFracture", "colossoSeismic", "colossoCore", "colossoDeath"]),
    transitionMs: 1900, deathDurationMs: 4600, attackCooldownMs: { 1: 6100, 2: 5000, 3: 4100 },
    attackTelegraphMs: { rift: { 1: 1500, 2: 1250, 3: 1100 }, slam: { 1: 1400, 2: 1200, 3: 1050 }, fracture: { 2: 1700, 3: 1450 }, seismic: { 3: 1400 } },
    attackExecutionMs: { rift: 650, slam: 850, fracture: 1900, seismic: 1400 },
    attackImpactProgress: { rift: .58, slam: .62, fracture: .42, seismic: .45 },
    core: { closedDamageFactor: .35, exposedDamageFactor: 1.6, exposedMs: 6000 },
    rift: { maxActive: { 1: 1, 2: 2, 3: 3 }, maxSpawnedEnemies: { 1: 5, 2: 9, 3: 13 }, durationMs: 9000, spawnDelayMs: 1100, spawnProfiles: { 1: [1, 2], 2: [1, 2, 3], 3: [2, 3] }, spawnTypes: [["cuspidorBrasa", "predadorCaldeira"], ["vermeIncubador", "cuspidorBrasa", "predadorCaldeira"], ["devoradorCaldeira", "predadorCaldeira", "salamandraCinerea"]] },
    slam: { damageFactor: { 1: .25, 2: .30, 3: .35 }, width: { 1: 3, 2: 3, 3: 4 }, stunMs: 1400 },
    fracture: { durationMs: { 2: 9000, 3: 12000 }, columns: [2, 3, 4, 5, 6], cellIntervalMs: 120 },
    seismic: { damageFactor: .18, stunMs: 1400, rowIntervalMs: 280 }, finalCollapse: { telegraphMs: 3600, rowIntervalMs: 300 },
    description: "Entidade colossal que domina todas as rotas com fissuras, magma e golpes sísmicos. O núcleo exposto é a janela decisiva de dano.",
  },
  leviathanNereida: {
    ...
    description: "Predador colossal das profundezas que controla a maré e rompe formações a partir do oceano.",
  },
  carapacaNereida: {
    id: "carapacaNereida",
    ...
    waterAnimationCycleDistance: 10,
    attackRangeTiles: 0.45,
    attackVisual: { durationMs: 800, impactMs: 400 },
    spawnDurationMs: 800,
    frontDamageFactor: 0.85, floodedFrontDamageFactor: 0.65,
    escortRangeTiles: 1.15, escortedRangedDamageFactor: 0.8,
    description: "Crustáceo-tanque que absorve fogo frontal e cria cobertura física para inimigos menores logo atrás.",
  },
  medusaVeuSalino: {
    id: "medusaVeuSalino",
    label: "Medusa Véu-Salino",
    role: "Suporte aquático / cura / enfraquecimento",
    ...
    firstHealDelayMs: 4200, healEveryMs: 7000, healTargetLimit: 4, healRangeTiles: 3.2, healAdjacentRows: 1,
    healPriorityTypes: ["mordelume"],
    ...
    spawnDurationMs: 800, deathDurationMs: 900,
    healVisual: { durationMs: 880, applyFrame: 5, applyAtMs: 550 },
    attackCastVisual: { durationMs: 640 },
    attackVisual: {
      aspectRatio: 1,
      muzzle: { x: 0.13, y: 0.62 },
      frameMuzzles: [
        { x: 0.26, y: 0.72 }, { x: 0.23, y: 0.69 },
        { x: 0.18, y: 0.65 }, { x: 0.13, y: 0.62 },
        { x: 0.19, y: 0.66 }, { x: 0.24, y: 0.70 },
        { x: 0.29, y: 0.73 }, { x: 0.31, y: 0.75 },
      ],
    },
    attackReleaseVisual: { durationMs: 480, projectileFrame: 3, projectileAtMs: 180 },
    description: "Água-viva abissal de retaguarda que cura aliados feridos e reduz a cadência das tropas.",
  },
  mordelume: {
    id: "mordelume",
    label: "Mordelume",
    ...
    attackRangeTiles: 0.45,
    attackVisual: { durationMs: 560, damageFrames: [4, 6] },
    spawnDurationMs: 640,
    deathDurationMs: 720,
    waterSpeedFactor: 1.3,
    sprintSpeedFactor: 1.45,
    sprintDurationMs: 850,
    sprintCooldownMs: 2500,
