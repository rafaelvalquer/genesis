...
export const CHAPTER_SEVEN_PHASES = deepFreeze(Array.from({ length: 8 }, (_, index) => ({
  ...
  convoy: { vehicleId: ["tr7_pioneiro", "tr7r_peregrino", "tr7a_bastilha", "tr7f_ferrum", "tr9_atlas", "tr9p_vertice", "tr9s_sobrevivente", "trx_exodo"][index], row: 2, escortRows: [1, 3], escortColumnRadius: 1,
    maxHp: 1000,
    checkpointProgress: [.25, .5, .75], destinationProgress: 1, targetUninterruptedTravelMs: 180000 + index * 6000,
