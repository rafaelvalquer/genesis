...
export const colossoCaldeiraBehavior = enemyBehavior({
  createState: (session, queued, config) => ({
    ...
    colossoAttackApplied: false, colossoRecentRows: [], colossoRecentCells: [], colossoRecentAttackSequence: [], colossoRifts: [], colossoRiftSpawnCounts: { 1: 0, 2: 0, 3: 0 }, colossoTargetCells: [], colossoRiftTarget: null, colossoImpactQueue: [], colossoCollapseRows: [], colossoCollapseIndex: 0, colossoNextCollapseImpactAt: Infinity,
