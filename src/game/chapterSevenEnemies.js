...
export const CHAPTER_SEVEN_ENEMIES = Object.freeze({
  ...
  garravinha: enemy("garravinha", "Garravinha", "Especialista antitransporte", {
    ...
    latch: {
      prepMs: 420, leapMs: 480, rangeTiles: 1.2, arcHeightPx: 60,
      initialDamage: 8, tickDamage: 14, tickEveryMs: 1000,
      interruptedCooldownMs: 2200, sideAttackDamage: 7, sideAttackEveryMs: 1400,
      attachOffsetX: 8, attachOffsetY: -38,
    },
    animationFrameMs: { idle: 140, walking: 105, latched: 120 },
    assetStates: ["idle", "walking", "attack", "latchPrep", "latchLeap", "latched", "death"],
  ...
  dardifago: enemy("dardifago", "Dardífago", "Artilharia da floresta", {
    ...
    rangedAttack: { rangeTiles: 4.4, projectileSpeed: 620, troopDamage: 9, convoyDamage: 7,
      firstShotDelayMs: 1300, durationMs: 960, releaseMs: 480, underAttackHoldMs: 2200 },
    toxinDart: { everyShots: 3, durationMs: 3000, attackSpeedFactor: .70, refreshDuration: true },
    animationFrameMs: { idle: 150, walking: 135 },
    attackVisual: { durationMs: 960, releaseMs: 480, releaseFrame: 4,
      releaseVisual: { offsetX: -46, offsetY: -22 } },
    assetStates: ["idle", "walking", "dartAttack", "toxicAttack", "death"],
