# Fase 40 — Reforço e balanceamento v1.2.1
...
## Correção da validação na v1.2.1
...
A v1.2.1 executa a auditoria de forma informativa e continua somente quando um relatório
...
```powershell
cd "C:\Projetos\Genesis\genesis-fase40-reforco-balanceamento-v1.2.1"
