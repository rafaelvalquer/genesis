# Genesis — Pulso de Desmaterialização Tático v1.0.1
...
```powershell
cd "C:\Projetos\Genesis\genesis-dematerialization-pulse-v1.0.1"
...
Esta versão corrige exclusivamente a execução do validador em PowerShell (`${Name}: OK`) e torna a captura de `LASTEXITCODE` explícita por etapa. Pode ser executada diretamente sobre uma instalação v1.0.0 já aplicada; não é necessário restaurar arquivos.
