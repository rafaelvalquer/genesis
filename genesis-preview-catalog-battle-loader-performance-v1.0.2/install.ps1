...
$ExpectedCommit = "9e647adfcfa73a27141f7d2c10661dc3dcfa7c08"
...
$backupRoot = Join-Path -Path $RepoRoot -ChildPath ".genesis-backups\gamecanvas-anchor-$timestamp"
...
try {
  ...
  if ($LASTEXITCODE -ne 0) {
    throw "Falha ao aplicar o hotfix do GameCanvas."
  }
  ...
  Write-Host ""
  Write-Host "Hotfix do GameCanvas instalado com sucesso."
}
catch {
