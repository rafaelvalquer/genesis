...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Instala o Capítulo 5, suas oito fases, "
            "tema de interface e kit 3D Eclipse."
        ),
    )
    parser.add_argument(
        "--repo-root",
    ...
    backup_root = (
        repo_root
        / ".genesis-backups"
        / f"chapter-05-eclipse-{timestamp}"
    )
    ...
    print(
        "[INFO] Tema Eclipse disponível no Comando, "
        "Campanha e planeta 3D."
    )
